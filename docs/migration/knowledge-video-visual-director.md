...
| `scripts/validate_library.py` | `d7755e70b07ede8a3707ea60c1d63ef37df2c78f9fd7c0deb80671ed8f7a47bf` | migrated | migrated | `scripts/toolkit/artifacts.py`, `scripts/toolkit/validation.py`, `references/policies/project-assets.md` | Safe paths, actual PNG alpha inspection, neutral action metadata, provenance, and promotion ownership move to structural validation. |
